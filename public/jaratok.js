...
(_b = document.getElementById('destinationDropDownMenuInput')) === null || _b === void 0 ? void 0 : _b.addEventListener("change", (event) => { const target = event.target; To_Airport = target.value; });
(_c = document.getElementById('passangersNumber')) === null || _c === void 0 ? void 0 : _c.addEventListener("change", (event) => { const target = event.target; Passangers = Number(target.value); });
(_d = document.getElementById('flyingDateData')) === null || _d === void 0 ? void 0 : _d.addEventListener("change", (event) => { const target = event.target; FlyingDateTime = target.value; });
